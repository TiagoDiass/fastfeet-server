...
func main() {
	...
	confirmDeliveredPackageUsecase := packageUsecase.NewConfirmDeliveredPackageUsecase(packageRepository)
	...
	router.Patch("/packages/confirm-delivery/{packageId}", packageHandler.ConfirmDeliveredPackage)
